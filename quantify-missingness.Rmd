...
for (i in 1:length(patient_obs_wide$Troponin)){
  ...
  if (is.na(patient_obs_wide$Troponin_high[i]) && !is.na(patient_obs_wide$Troponin_normal[i])) {
    patient_obs_wide$Troponin[i] = patient_obs_wide$Troponin_normal[i]
  }
  if (is.na(patient_obs_wide$Troponin_high[i]) && is.na(patient_obs_wide$Troponin_normal[i])) {
    patient_obs_wide$Troponin[i] = patient_obs_wide$Troponin_normal[i]
  }
...
```{r}
save(df_prop,df_num,df_prop_Sex,df_prop_Severity,temporal,temporal_severe,temporal_nonsevere,longhaul_comb,longhaul,shorthaul_comb,shorthaul,props_quant,props_M_quant,props_F_quant,props_S_quant,props_NS_quant,samplesize,ssM,ssF,ssS,ssNS,
