...
if (ncol(df) == 1) {
  plot(df_ind[,1],df[,1],pch=NA,ylim=c(0,1),xlab="Days since admission",ylab="Spearman Correlation")
...
return(c(df,df_ind,final_names))
...
df1 = lab_temporal(names1)[1]
df2 = lab_temporal(names2)[1]
df3 = lab_temporal(names3)[1]
df4 = lab_temporal(names4)[1]
df5 = lab_temporal(names5)[1]

final_names1 = lab_temporal(names1)[3]
final_names2 = c(lab_temporal(names2)[7],lab_temporal(names2)[8],lab_temporal(names2)[9])
final_names3 = c(lab_temporal(names3)[7],lab_temporal(names3)[8],lab_temporal(names3)[9])
final_names4 = lab_temporal(names4)[3]
final_names5 = c(lab_temporal(names5)[7],lab_temporal(names5)[8],lab_temporal(names5)[9])

interesting_temporal_penn = cbind(df1,df2,df3,df4,df5)

#compare between severe vs. non-severe

te_labs2 <- Severe_patients %>% 
  filter(days_since_admission < 100,
         days_since_admission >= 0) %>% 
  mutate(te = patient_num %in% unique(te_patients$patient_num))
...
df1_s = lab_temporal(names1)[1]
df2_s = c(lab_temporal(names2)[1],lab_temporal(names2)[2],lab_temporal(names2)[3])
df3_s = c(lab_temporal(names3)[1],lab_temporal(names3)[2],lab_temporal(names3)[3])
df4_s = lab_temporal(names4)[1]
df5_s = c(lab_temporal(names5)[1],lab_temporal(names5)[2],lab_temporal(names5)[3])




te_labs2 <- Nonsevere_patients %>% 
  filter(days_since_admission < 100,
         days_since_admission >= 0) %>% 
  mutate(te = patient_num %in% unique(te_patients$patient_num))
...
df1_ns = lab_temporal(names1)[1]
df2_ns = c(lab_temporal(names2)[1],lab_temporal(names2)[2],lab_temporal(names2)[3])
df3_ns = c(lab_temporal(names3)[1],lab_temporal(names3)[2],lab_temporal(names3)[3])
df4_ns = lab_temporal(names4)[1]
df5_ns = c(lab_temporal(names5)[1],lab_temporal(names5)[2],lab_temporal(names5)[3])


#group 1

par(mfrow=c(2,1),omi=c(0.5,0.7,.5,.7), plt=c(0.1,0.9,.1,0.6))

indices = seq(1,length(mat_list),1)

plot(indices,data.frame(df1_s)[,1],pch=NA,ylim=c(-.5,1),xlab="",ylab="")
  title("Severe",line=.5,cex.main=.9,font.main=1)
  lines(indices,data.frame(df1_s)[,1],col=rainbow(length(df1_s)))
  
plot(indices,data.frame(df1_ns)[,1],pch=NA,ylim=c(-.5,1),xlab="",ylab="")
  title("Non-Severe",line=.5,cex.main=.9,font.main=1)
  lines(indices,data.frame(df1_ns)[,1],col=rainbow(length(df1_ns)))

mtext("Days since admission",side=1,line=1.2,outer=TRUE,cex=.9)
mtext("Spearman Correlation",side=2,line=.6,outer=TRUE,cex=.9,las=0)
mtext(final_names1[[1]],side=3,line=-.8,outer=TRUE,cex = 1.2,font.main=2)

#group 2

df = df2_s

par(mfrow=c(3,1),omi=c(0.5,0.3,0,0), plt=c(0.1,0.9,0,0.5))

for (i in 1:length(df)){
  plot(indices,data.frame(df)[,i],pch=NA,ylim=c(-.5,1),xlab="",ylab="")
  title(final_names2[i],line=.5,cex.main=1.1,font.main=1)
  lines(indices,data.frame(df)[,i],col=rainbow(length(df)))
}
mtext("Days since admission",side=1,line=2.2,outer=TRUE,cex=.8)
mtext("Spearman Correlation",side=2,line=.8,outer=TRUE,cex=.8,las=0)
mtext("Severe",side=3,line=-2.5,outer=TRUE,cex = 1.2,font.main=2)
...
mtext("Days since admission",side=1,line=2.2,outer=TRUE,cex=.8)
mtext("Spearman Correlation",side=2,line=.8,outer=TRUE,cex=.8,las=0)
mtext("Non-Severe",side=3,line=-2.5,outer=TRUE,cex = 1.2,font.main=2)
...
for (i in 1:length(df)){
  plot(indices,data.frame(df)[,i],pch=NA,ylim=c(-.5,1),xlab="",ylab="")
  title(final_names3[i],line=.5,cex.main=1.1,font.main=1)
  lines(indices,data.frame(df)[,i],col=rainbow(length(df)))
}
mtext("Days since admission",side=1,line=2.2,outer=TRUE,cex=.8)
mtext("Spearman Correlation",side=2,line=.8,outer=TRUE,cex=.8,las=0)
...
plot(indices,data.frame(df4_s)[,1],pch=NA,ylim=c(-.5,1),xlab="",ylab="")
  title("Severe",line=.5,cex.main=.9,font.main=1)
  lines(indices,data.frame(df4_s)[,1],col=rainbow(length(df4_s)))
  
plot(indices,data.frame(df4_ns)[,1],pch=NA,ylim=c(-.5,1),xlab="",ylab="")
  title("Non-Severe",line=.5,cex.main=.9,font.main=1)
  lines(indices,data.frame(df4_ns)[,1],col=rainbow(length(df4_ns)))

mtext("Days since admission",side=1,line=1.2,outer=TRUE,cex=.9)
mtext("Spearman Correlation",side=2,line=.6,outer=TRUE,cex=.9,las=0)
mtext(final_names4[[1]],side=3,line=-.8,outer=TRUE,cex = 1.2,font.main=2)
...
for (i in 1:length(df)){
  plot(indices,data.frame(df)[,i],pch=NA,ylim=c(-.5,1),xlab="",ylab="")
  title(final_names5[i],line=.5,cex.main=1.1,font.main=1)
  lines(indices,data.frame(df)[,i],col=rainbow(length(df)))
}
mtext("Days since admission",side=1,line=2.2,outer=TRUE,cex=.8)
mtext("Spearman Correlation",side=2,line=.8,outer=TRUE,cex=.8,las=0)
...
```{r}
save(penn_na_df, penn_patient_lab, penn_agg_n_values,df_prop_penn,df_num_penn,df_prop_Sex_penn,df_prop_Severity_penn,highcorr_temporal_penn,interesting_temporal_penn,longhaul_comb_penn,longhaul_penn,shorthaul_comb_penn,shorthaul_penn,bin_nobs_penn,
